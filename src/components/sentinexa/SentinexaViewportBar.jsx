  ...
  return (
    <header className="bg-white border-b border-slate-200 px-4 py-2.5 flex flex-wrap items-center justify-between gap-3 shrink-0 z-[3000] sticky top-0 shadow-xs">
      ...
      <div className="flex items-center gap-2.5">
        <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center shadow-md shadow-blue-500/20 text-white">
          <Shield className="w-4 h-4" />
        </div>
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xs font-black tracking-wider text-slate-900">SENTINEXA</h1>
          ...
          <p className="text-[10px] text-slate-500 font-mono hidden sm:block">
            Autonomous Multi-Agent Platform · Light Edition
          </p>
        </div>
      </div>
